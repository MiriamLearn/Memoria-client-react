...
// import { ArrowLeft, Upload, Trash2, Edit, ImageIcon, Home, Maximize2, Download } from "lucide-react"
...
//       const imagesData: Image[] = response.data.imageList?.filter((image: any) => !image.isDeleted) || []
...
//               {albumName}
//             </Typography>
//             <Button variant="contained" color="primary" sx={{backgroundColor:"#f49b85"}}startIcon={<Upload size={18} />} onClick={handleUpload}>
//               העלאת תמונה
//             </Button>
//           </Box>

//           <Chip label={`${images.length} תמונות`} size="small"  variant="outlined" sx={{ mt: 1 ,color:"#df8670",borderColor:"#f49b85"}} />
//         </Box>
...
//               </Typography>
//               <Button variant="contained" startIcon={<Upload size={18} />}sx={{ backgroundColor: "#f49b85" }} onClick={handleUpload}>
//                 העלה תמונה ראשונה
//               </Button>
//             </Box>
//           </Paper>
...
//                 ביטול
//               </Button>
//               <Button variant="contained" onClick={handleUpdate} disabled={!selectedFile}sx={{backgroundColor:"#f49b85"}}>
//                 עדכן
//               </Button>
//             </Box>
//           </Box>
...
//                     <Box>
//                       {/* <Tooltip title="הורד">
//                         <IconButton onClick={() => handleDownloadImage(previewImage)}>
//                           <Download size={20} />
//                         </IconButton>
//                       </Tooltip> */}
//                       <Tooltip title="ערוך">
