...
// טיפוס לpresigned URL
interface PresignedUrlResponse {
  url: string
}

// טיפוס לprogress event
...
const FileUploader = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      } as any) // הוספת as any כדי לעקוף את בעיית הטיפוס
      ...
      await axios.post<Image>("https://localhost:7251/api/Image", imageData)
          ...
          <CardContent sx={{ p: 4 }}>
            ...
            <Box sx={{ display: "flex", justifyContent: "space-between", mt: 3 }}>
              <Button
                ...
                sx={{ color: "#f49b85", borderColor: "#f49b85" }}
              >
                ביטול
              </Button>
              <Button
